...
\end{equation}
Here, $\nu = 11246\unit{Hz}$ is the LHC revolution frequency and $\sigma_\text{vis}$ is the the visible cross section. A Van der Meer scan \cite{Balagura:2011yw} is used to calibrate $\sigma_\text{vis}$. In 2012, CMS measured the total integrated luminosity with a systematic uncertainty of 2.6\% using this method.
