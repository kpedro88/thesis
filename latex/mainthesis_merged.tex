...
\hrefCMSnoop {} {{MissMJ} {et~al.}, ``Standard Model of Elementary
  Particles''.} Creative Commons Attribution 3.0 Unported License,
  \url{http://creativecommons.org/licenses/by/3.0/deed.en}, Jul, 2014.
\newblock
...
\hrefCMSnoop {} {{ CMS} Collaboration, ``Observation of a new boson at a mass
  of 125 GeV with the \{CMS\} experiment at the \{LHC\}'',} \textit{ Phys.
  Lett. B} \textbf{ 716} (2012) 30,
...
\hrefCMSnoop {} {E.~Drexler, ``Elementary particle interactions in the Standard
  Model''.} Creative Commons CC0 1.0 Universal Public Domain Dedication,
  \url{http://creativecommons.org/publicdomain/zero/1.0/deed.en}, May, 2014.
\newblock
