...
\def\vecpt{\mbox{$\vec{p}_T$}\ } % PT vector
...
\def\mutau{\ensuremath{\mu\tau}\xspace}
\def\etau{\ensuremath{e\tau}\xspace}
\def\emu{\ensuremath{e\mu}\xspace}
\def\ltau{\ensuremath{\ell\tau}\xspace}
